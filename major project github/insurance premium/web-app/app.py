...
def predict():
    ...
    if form.submit():
        ...
        header = {'Content-Type': 'insurance-premium\web-app\apikey.json', 'Authorization': 'Bearer '
                 + "cJH7pgDJA26ufcJiAQvQZR8lyFPd2O3vdlcMSC5g4o4K"}
        ...
        response_scoring = requests.post("https://eu-de.ml.cloud.ibm.com/ml/v4/deployments/5dc5f78d-0154-45cf-ad46-f43aeddcaac1/predictions?version=2021-05-01", json=payload_scoring, headers=header)
